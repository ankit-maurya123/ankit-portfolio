...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (typedText) {
        const texts = ['PHP Developer', 'Next.js Developer', 'React.js Developer', 'Node.js Developer', 'CodeIgniter 4 Developer'];
        let textIndex = 0;
        let charIndex = 0;
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function(e) {
            ...
            console.log('Sending form to:', formAction);
            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    if (data.csrf_token) {
                        const csrfInput = contactForm.querySelector('input[name="csrf_test_name"]');
                        if (csrfInput) {
                    ...
                    let errorMsg = data.message || 'Please fix the errors and try again.';
                    if (data.errors) {
